<?php return array (
  ...
  array (
    ...
    'templates|mobile|link' => 
    array (
      'index.html' => '',
      'list_type.html' => '分类页',
      'register.html' => '申请页',
    ),
    'templates|mobile|special' => 
    array (
      'api_picture.html' => '组图',
    ...
    'templates|mobile|announce' => 
    array (
      'show.html' => '内容页',
    ),
    'templates|mobile|wap' => 
    array (
    ...
    'templates|mobile|formguide' => 
    array (
      'index.html' => '表单列表页模板',
      'show.html' => '表单详情页模板',
      'show_js.html' => '表单js调用模板',
    ),
    'templates|mobile|mood' => 
    array (
      'index.html' => '新闻心情',
    ),
    'templates|mobile|yp' => 
    ...
    'templates|mobile|yp|com_mobile' => 
    array (
      'index.html' => '公司首页模板',
      'style' => '样式文件夹',
    ),
    'templates|mobile|comment' => 
    array (
