<?php return array (
  ...
  array (
    ...
    'templates|yibo_en|link' => 
    array (
      'index.html' => '',
      'list_type.html' => '分类页',
      'register.html' => '申请页',
    ),
    'templates|yibo_en|special' => 
    array (
      'api_picture.html' => '组图',
    ...
    'templates|yibo_en|announce' => 
    array (
      'show.html' => '内容页',
    ),
    'templates|yibo_en|wap' => 
    array (
    ...
    'templates|yibo_en|phpsso' => 
    array (
      'index.html' => '首页',
    ),
    'templates|yibo_en|search' => 
    array (
      'footer.html' => '页尾',
      'header.html' => '页头',
      'index.html' => '首页',
    ...
    'templates|yibo_en|formguide' => 
    array (
      'index.html' => '表单列表页模板',
      'show.html' => '表单详情页模板',
      'show_js.html' => '表单js调用模板',
    ),
    'templates|yibo_en|mood' => 
    array (
      'index.html' => '新闻心情',
    ),
    'templates|yibo_en|yp' => 
    array (
      'com_yibo_en' => '企业默认模板',
      'index.html' => '黄页首页模板',
      'list.html' => '列表页模板',
    ...
    'templates|yibo_en|yp|com_yibo_en' => 
    array (
      'index.html' => '公司首页模板',
      'style' => '样式文件夹',
    ),
    'templates|yibo_en|comment' => 
    array (
